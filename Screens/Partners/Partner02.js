...
const Partner02 = (props) => {
  ...
  const getPartnersAll = () => {
    ...
    PartnersApi.getPartners('proc_partner_list', 'popular', null, 'y', null)
      .then((res) => {
  ...
  const getPartnersPackage = () => {
    ...
    PartnersApi.getPartners('proc_partner_list', 'popular', '1', 'y', null)
      .then((res) => {
        if (res.data.result === '1' && res.data.count > 0) {
  ...
  const getPartnersGeneral = () => {
    ...
    PartnersApi.getPartners('proc_partner_list', 'popular', '0', 'y', null)
      .then((res) => {
        if (res.data.result === '1' && res.data.count > 0) {
  ...
  const getPartnersEtc = () => {
    ...
    PartnersApi.getPartners('proc_partner_list', 'popular', '2', 'y', null)
      .then((res) => {
        if (res.data.result === '1' && res.data.count > 0) {
