...
const Partner02 = (props) => {
  ...
  const getPartnersAll = (payload) => {
    ...
    PartnersApi.getPartners('popular', null, 'y', null, payload)
      .then((res) => {
  ...
  const getPartnersPackage = (payload) => {
    ...
    PartnersApi.getPartners('popular', '1', 'y', null, payload)
      .then((res) => {
        if (res.data.result === '1' && res.data.count > 0) {
  ...
  const getPartnersGeneral = (payload) => {
    ...
    PartnersApi.getPartners('popular', '0', 'y', null, payload)
      .then((res) => {
        if (res.data.result === '1' && res.data.count > 0) {
  ...
  const getPartnersEtc = (payload) => {
    ...
    PartnersApi.getPartners('popular', '2', 'y', null, payload)
      .then((res) => {
        if (res.data.result === '1' && res.data.count > 0) {
