      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
          ...
          <View style={[styles.infoBox, { marginBottom: 20 }]}>
            ...
            <View style={styles.details}>
              ...
              <View
                ...
                <Text style={[styles.detailsDesc, { color: '#275696', marginLeft: 5 }]}>
                  (조정필요)
                </Text>
              </View>
            </View>
        ...
        <View style={[styles.wrap, { marginVertical: 10 }]}>
          ...
          <View style={[styles.infoBox, { marginBottom: 10 }]}>
            <View style={styles.details}>
              ...
              <Text style={styles.detailsDesc}>100,000원</Text>
            </View>
            <View style={styles.details}>
              <Text style={styles.detailsTitle02}>디자인비</Text>
              <Text style={styles.detailsDesc}>30,000원</Text>
            </View>
            <View style={styles.details}>
              <Text style={styles.detailsTitle02}>배송비</Text>
              <Text style={styles.detailsDesc}>2,500원</Text>
            </View>
            <View style={styles.details}>
              <Text style={styles.detailsTitle02}>총 비용</Text>
              <Text style={styles.detailsDesc}>132,500원</Text>
            </View>
          </View>
        </View>
        ...
        <View style={[styles.wrap, { marginVertical: 10 }]}>
          ...
          <View style={[styles.infoBox, { marginBottom: 10 }]}>
            <View style={styles.details}>
              ...
              <Text style={styles.detailsDesc}>10%</Text>
            </View>
            <View style={styles.details}>
              <Text style={styles.detailsTitle02}>계약금(선금)</Text>
              <Text style={styles.detailsDesc}>13,250원</Text>
            </View>
          </View>
          <View
            style={{
            ...
            <Text
              style={[
                styles.normalText,
                { fontSize: 12, color: '#275696', lineHeight: 18, marginRight: 3 },
              ]}>
              ※
            </Text>
            <Text style={[styles.normalText, { fontSize: 12, color: '#275696', lineHeight: 18 }]}>
              파트너사선정이 확정되면 입금계좌정보는 알림 메시지를 통해 확인 가능합니다.
            </Text>
          </View>
        </View>
        ...
        <View style={[styles.wrap, { marginVertical: 10 }]}>
          ...
          <View style={[styles.infoBox, { marginBottom: 10 }]}>
            <View style={styles.details}>
              <Text
                style={[styles.detailsTitle02, { color: '#111', lineHeight: 22, width: '100%' }]}>
                보내주신 주문사항을 확인을 하였으나 실제 인쇄시 재단 밀림 가능성이 있기에 디자인
                수정이 필요합니다. 디자인 수정을 하게 되었을 시 견적 비용은 상이해질 수 있으나
                원하시는 디자인대로 인쇄 가능하오니, 검토 부탁드립니다.
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={[styles.wrap, { marginVertical: 10 }]}>
          ...
          <View style={[styles.infoBox, { marginBottom: 10 }]}>
            <TouchableOpacity
              ...
              />
              <Text style={styles.normalText}>인쇄견적서.pdf</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
