      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.wrap}>
          <View style={[styles.infoBox, { marginBottom: 20 }]}>
            <Text style={styles.infoStepDesc}>납품 완료</Text>
        ...
        <View style={styles.wrap}>
          ...
          <View style={{ marginBottom: 10 }}>
            ...
            <View
              ...
              <Text style={{ fontSize: 14, color: '#366DE5' }}>사진 등록 대기중</Text>
            </View>
          </View>
          {/* // 제작 현황 */}
        </View>
        ...
        <View style={{ paddingHorizontal: 20, marginBottom: 50 }}>
          {/* 버튼 */}
          <TouchableOpacity onPress={() => Alert.alert('수령 완료 전송')} activeOpacity={0.9}>
            <View style={[styles.submitBtn]}>
              <Text style={styles.submitBtnText}>수령 완료</Text>
            </View>
          </TouchableOpacity>
          {/* // 버튼 */}
        </View>
