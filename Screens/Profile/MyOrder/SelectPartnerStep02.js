...
const SelectPartnerStep02 = (props) => {
    ...
    <>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.wrap}>
          ...
          {/* 버튼 */}
          <TouchableOpacity
            onPress={() => Alert.alert('입금 완료 전송', '업체에 전송하였습니다.')}
            activeOpacity={0.8}>
            <View style={[styles.goHomeBtn, { marginBottom: 5 }]}>
              <Text style={styles.goHomeBtnText}>선금 입금 완료</Text>
            </View>
          </TouchableOpacity>
...
export default SelectPartnerStep02;
