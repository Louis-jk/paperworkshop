      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        <View style={styles.wrap}>
          <View style={[styles.infoBox, { marginBottom: 15 }]}>
            <Text style={styles.infoStepDesc}>수령 완료</Text>
        ...
        <View style={styles.wrap}>
          ...
          <View style={{ marginBottom: 10 }}>
            ...
            <View
              ...
              <Text style={{ fontSize: 14, color: '#000' }}>인쇄 제작 요청</Text>
              <Text style={{ fontSize: 14, color: '#979797' }}>2020.11.01 11:45</Text>
            </View>
            <View
              style={{
                flexDirection: 'row',
              ...
              <Text style={{ fontSize: 14, color: '#000' }}>납품 완료</Text>
              <Text style={{ fontSize: 14, color: '#979797' }}>2020.11.03 12:02</Text>
            </View>
            <View
              style={{
                flexDirection: 'row',
              ...
              <Text style={{ fontSize: 14, color: '#000' }}>수령 완료</Text>
              <Text style={{ fontSize: 14, color: '#979797' }}>2020.11.05 16:13</Text>
            </View>
          </View>
          {/* // 제작 현황 */}
        </View>
        ...
        <View style={{ paddingHorizontal: 20, marginBottom: 50 }}>
          {/* 버튼 */}
          <TouchableOpacity onPress={() => navigation.navigate('Review')} activeOpacity={0.9}>
            <View style={[styles.submitBtn]}>
              <Text style={styles.submitBtnText}>후기 작성</Text>
            </View>
          </TouchableOpacity>
          {/* // 버튼 */}
        </View>
