...
const index = (props) => {
  ...
  const getPartnersAll = (payload) => {
    ...
    PartnersApi.getMyPartners(mb_id, null, null, null, null, payload)
      .then((res) => {
  ...
  const getPartnersPackage = (payload) => {
    ...
    PartnersApi.getMyPartners(mb_id, null, '1', null, null, payload)
      .then((res) => {
        if (res.data.result === '1' && res.data.count > 0) {
  ...
  const getPartnersGeneral = (payload) => {
    ...
    PartnersApi.getMyPartners(mb_id, null, '0', null, null, payload)
      .then((res) => {
        if (res.data.result === '1' && res.data.count > 0) {
  ...
  const getPartnersEtc = (payload) => {
    ...
    PartnersApi.getMyPartners(mb_id, null, '2', null, null, payload)
      .then((res) => {
        if (res.data.result === '1' && res.data.count > 0) {
